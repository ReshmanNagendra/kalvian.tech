  ...
  return (
    <div className="flex items-center justify-center min-h-[calc(100vh-3.5rem)] px-4">
      <div className="max-w-md w-full bg-surface-card border border-surface-border rounded-xl p-8 shadow-xl">
        ...
        <p className="text-center text-text-secondary text-sm mb-6">Join Kalvian Tech Productivity Suite</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button 
            disabled={loading}
            type="submit" 
            className="w-full bg-brand-600 hover:bg-brand-500 text-white font-medium py-2 rounded-lg transition-colors disabled:opacity-50 mt-2"
          >
